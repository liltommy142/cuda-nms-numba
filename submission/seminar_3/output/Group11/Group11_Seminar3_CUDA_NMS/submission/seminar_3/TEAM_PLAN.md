# Team plan and completion record — Group 11
...
- [x] CPU, V1, and V2 are tested as class-aware hard-NMS implementations.
- [x] CUDA test and benchmark evidence is retained with machine provenance.
- [x] `FINAL_REPORT.ipynb` executes the small parity check and reads the saved
  NMS-only evidence.
- [x] Both members can explain the candidate contract, GPU strategy, evidence
